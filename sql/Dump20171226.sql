...
CREATE TABLE `post_extends` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8 COMMENT='文章扩展表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `post_extends` VALUES (38,9,23,0,0,0),(39,6,8,0,0,0),(40,10,1,0,0,0),(41,11,1,0,0,0),(42,12,7,0,0,0),(43,13,1,0,0,0),(44,14,16,0,0,0),(45,15,25,0,0,0),(46,16,2,0,0,0),(47,17,268,0,0,0),(48,18,31,0,0,0),(49,19,4,0,0,0),(50,20,14,0,0,0),(51,8,1,0,0,0),(52,21,4,0,0,0),(53,22,6,0,0,0),(54,23,2,0,0,0),(55,24,1,0,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='文章主表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-26 21:40:22
