...
{    
    ...
    {
        $this->items = [
            ['label' =>'<i class="fa fa-dashboard"></i><span>关于</span>','url'=>['site/index']],
            ['label' =>'<a href=""><i class="fa fa-th-list"></i><span>内容管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>Yii::t('common','Post Manage'),'url'=>['post/index'],'items'=>[
                        //['label'=>'创建文章','url'=>['post/create'],'visible'=>false],

                            ['label'=>'编辑文章','url'=>['post/update'],'visible'=>false],
                            ['label'=>'文章详情','url'=>['post/view'],'visible'=>false],
                        ],
                    ],
                    ['label'=>Yii::t('common','Cat Manage'),'url'=>['cat/index'],'items'=>[
                        ['label'=>'创建分类','url'=>['cat/create'],'visible'=>false],
                        ['label'=>'编辑分类','url'=>['cat/update'],'visible'=>false],
                        ['label'=>'分类详情','url'=>['cat/view'],'visible'=>false],
                        ]                        
                    ],
                    ['label'=>Yii::t('common','Tag Manage'),'url'=>['tag/index'],'items'=>[
                        ['label'=>'创建标签','url'=>['tag/create'],'visible'=>false],
                        //['label'=>'编辑标签','url'=>['tag/update'],'visible'=>false],
            ...
            ['label' =>'<a href=""><i class="fa fa-user"></i><span>会员管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>Yii::t('common','User Manage'),'url'=>['user/index'],'items'=>[

                ['label'=>'编辑用户信息','url'=>['user/update'],'visible'=>false],
                ['label'=>'用户详情','url'=>['user/view'],'visible'=>false],
